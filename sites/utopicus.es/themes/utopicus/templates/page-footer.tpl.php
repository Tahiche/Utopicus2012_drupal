...
<div class="fb-like" data-href="http://www.utopicus.es" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
    ...
    <img src="<?php print $theme_pathabsoluto; ?>/images/logos/edisa.png" alt="EDISA" />
			...
			<div class="box">
				...
				<ul>
                	<li><a href="/es/coworking">Tour</a></li>
			...
			<div class="box">
				...
				<ul>
					<li><a href="/es/coworking/actividades/agenda-eventos">Agenda</a></li>
			...
			<div class="box">
				...
				<ul>
					<li><a href="<?php echo url("_US/el_proyecto") ?>">El proyecto</a></li>
                                    ...
                                    <li><a href="<?php echo url("_US/coworking/noticias") ?>">Noticias</a></li>
		...
		<div class="footer-bar">
			...
			<div class="alignright">
				...
				<ul class="social-networks">
					...
					<li><a class="twitter" href="http://www.twitter.com/utopic_US">twitter<span class="mask">&nbsp;</span></a></li>
