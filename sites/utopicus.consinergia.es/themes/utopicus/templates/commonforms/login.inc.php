...
<div class="user-login-block " id="toboggan-login" style="display: none;"><div id="edit-name-wrapper" class="form-item">
 <label for="edit-name">Username or e-mail: <span title="Este campo es obligatorio." class="form-required">*</span></label>
...
<div class="item-list"><ul><li class="first"><a title="Crear una nueva cuenta de usuario." href="/es/user/register">Crear nueva cuenta</a></li>
<li class="last"><a title="Solicita una contraseña nueva por correo electrónico." href="/es/user/password">Solicitar una nueva contraseña</a></li>
